...
tab x_group, summ( vac01_09x) nofreq nostandard
regress vac01_09 ib2.x_group

tab x_group, summ( si_21) nofreq nostandard
regress si_21    ib2.x_group

tab x_group, summ( trustgov) nofreq nostandard
regress trustgov ib2.x_group

tab x_group, summ( trustsci) nofreq nostandard 
regress trustsci ib2.x_group

tab x_group, summ( regenforc) nofreq nostandard 
...
* The Vaccination-Trust scores by country 
* ========================================================================================

egen x_vac01_09xSTD = std( vac01_09x)
egen x_trustgovSTD =  std( trustgov)

* ---- Male Score

regress leloss21_m ib2.x_group x_vac01_09xSTD x_trustgovSTD , robust
gen x_VacplusTrust_M= _b[x_vac01_09xSTD]*x_vac01_09xSTD + _b[x_trustgovSTD]*x_trustgovSTD
regress leloss21_m ib2.x_group x_VacplusTrust_M, robust

gsort -x_VacplusTrust_M
display("======= Male Vaccination+Trust scores")
list country x_VacplusTrust_M, notrim

* ---- Female Score

regress leloss21_f ib2.x_group x_vac01_09xSTD x_trustgovSTD , robust
gen x_VacplusTrust_F= _b[x_vac01_09xSTD]*x_vac01_09xSTD + _b[x_trustgovSTD]*x_trustgovSTD
regress leloss21_f ib2.x_group x_VacplusTrust_F, robust

gsort -x_VacplusTrust_F
display("======= Female Vaccination+Trust scores")
list country x_VacplusTrust_F, notrim